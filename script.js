...
const careerMapping = [
    ...
    { answers: ["Working indoors","Part-time job","Alone", "Hard work"], career: { name: "Lucky Plumbman", image: "img.jpg" } },
    { answers: ["Working outdoors","Full-time job","Teamwork", "Easy work"], career: { name: "Begging together", image: "img/thosuaongnuoc.jpg" } },
